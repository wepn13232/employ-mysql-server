var counselorSqlMap = {
    add: 'insert into counselorInfo(counselorNo,counselorName,idCard,department,profession,education,politicalStatus,biogenicLand,graduationTime,counselorTel,familyContact,homeTel,homeAddress) values(?, ?,?, ?,?, ?,?, ?,?, ?,?, ?,?)',
