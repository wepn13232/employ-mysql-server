var studentSqlMap = {
    ...
    update: 'update studentInfo set stuNo=?,stuName=?,idCard=?,department=?,profession=?,education=?,politicalStatus=?,biogenicLand=?,graduationTime=?,stuTel=?,familyContact=?,homeTel=?,homeAddress=? where stuNo =?',
